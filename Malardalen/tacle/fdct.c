/* *********************************************************************************************************
 *													   *
 * DESCRIPTION: Fast Discrete Cosine Transform, used on 8x8 image blocks to * reassemble blocks in order   *
 * to ease quantization compressing image information on the more significant frequency components         *
 * 												           *
 * 													   *
 * COMMENTS: A lot of calculations based on array elements 						   *
 *                                                                                                         * 
