...
void WaitMail (incoming_mail_t EXTERNAL *message) COMPACT_DATA REENTRANT_FUNC __attribute__((noinline));
...
/* SH: We need to prevent this function from inlining, otherwise
 * we get multiple defined symbols.
 */
void Start_Conversion (void) __attribute__((noinline));
...
unsigned char End_Of_ADC (void) __attribute__((noinline));
...
unsigned char V_Down (void) __attribute__((void));
